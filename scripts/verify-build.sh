...
grep -q "juan-online-v1.3.3.2-maintenance-shop2" "$ROOT/online/sw.js" || { echo 'Online SW cache version stale'; exit 1; }
grep -q "juan-workspace-v1.3.3.2-maintenance-shop2" "$ROOT/workspace/sw.js" || { echo 'Workspace SW cache version stale'; exit 1; }
