...
function bind(){
  ...
  const detailStartProject=document.getElementById('detailStartProject');if(detailStartProject)detailStartProject.onclick=()=>{state.shopItem=null;window.JuanSuite?.shop();render()};
}
